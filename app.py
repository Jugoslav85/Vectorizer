...
def api_vectorize():
    ...
    settings = {
        ...
        "unsharp_radius":         gf("unsharp_radius",         1.5),
        "unsharp_percent":        gi("unsharp_percent",         180),
        "clahe":                  request.form.get("clahe",               "1") == "1",
        "clahe_clip":             gf("clahe_clip",              2.0),
        "clahe_tile":             gi("clahe_tile",              8),
        "edge_contrast":          request.form.get("edge_contrast",       "1") == "1",
        "edge_contrast_boost":    gf("edge_contrast_boost",    1.8),
        "tonal_separation":       request.form.get("tonal_separation",    "0") == "1",
        "tonal_shadow_end":       gi("tonal_shadow_end",        80),
        "tonal_shadow_out":       gi("tonal_shadow_out",        160),
    ...
    try:
        svg = vectorize(
            ...
            edge_contrast          = settings["edge_contrast"],
            edge_contrast_boost    = settings["edge_contrast_boost"],
            tonal_separation       = settings["tonal_separation"],
            tonal_shadow_end       = settings["tonal_shadow_end"],
            tonal_shadow_out       = settings["tonal_shadow_out"],
