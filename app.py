...
def api_vectorize():
    ...
    settings = {
        ...
        # Pre-processing
        "unsharp_mask":           request.form.get("unsharp_mask",         "1") == "1",
        "unsharp_radius":         gf("unsharp_radius",          1.0),
        "unsharp_percent":        gi("unsharp_percent",          100),
        "clahe":                  request.form.get("clahe",                "0") == "1",
        "clahe_clip":             gf("clahe_clip",               2.0),
        "lab_shadow_lift":        request.form.get("lab_shadow_lift",      "0") == "1",
        "lab_shadow_strength":    gf("lab_shadow_strength",      0.4),
        "lab_shadow_end":         gi("lab_shadow_end",           100),
        "saturation_boost":       request.form.get("saturation_boost",     "0") == "1",
        "saturation_factor":      gf("saturation_factor",        1.3),
        "global_contrast":        request.form.get("global_contrast",      "0") == "1",
        "global_contrast_factor": gf("global_contrast_factor",  1.2),
        "colour_quantise":        request.form.get("colour_quantise",      "0") == "1",
        "colour_quantise_n":      gi("colour_quantise_n",        32),
        ...
        # Post-processing
        "smart_path_retention":   request.form.get("smart_path_retention", "1") == "1",
        "smart_proximity":        gf("smart_proximity",          8.0),
        "simplify_epsilon":       gf("simplify_epsilon",         0.1),
        "thin_path_stroke":       request.form.get("thin_path_stroke",     "1") == "1",
        "thin_path_max_size":     gf("thin_path_max_size",       6.0),
        "thin_stroke_width":      gf("thin_stroke_width",        0.5),
    ...
    try:
        svg = vectorize(
            ...
            unsharp_mask           = settings["unsharp_mask"],
            ...
            lab_shadow_lift        = settings["lab_shadow_lift"],
            lab_shadow_strength    = settings["lab_shadow_strength"],
            lab_shadow_end         = settings["lab_shadow_end"],
            saturation_boost       = settings["saturation_boost"],
            saturation_factor      = settings["saturation_factor"],
            global_contrast        = settings["global_contrast"],
            global_contrast_factor = settings["global_contrast_factor"],
            colour_quantise        = settings["colour_quantise"],
            colour_quantise_n      = settings["colour_quantise_n"],
            ...
            smart_path_retention   = settings["smart_path_retention"],
            smart_proximity        = settings["smart_proximity"],
            simplify_epsilon       = settings["simplify_epsilon"],
            thin_path_stroke       = settings["thin_path_stroke"],
            thin_path_max_size     = settings["thin_path_max_size"],
            thin_stroke_width      = settings["thin_stroke_width"],
